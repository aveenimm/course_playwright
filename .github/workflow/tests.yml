  ...
  run-tests:
    ...
    steps:
      ...
      - name: Check out repository
        uses: actions/checkout@v5  # Используем GitHub Action для клонирования репозитория
      ...
      - name: Set up Python
        ...
        with:
          python-version: '3.13.5'  # Устанавливаем версию Python 3.11 (можно заменить на другую версию)
